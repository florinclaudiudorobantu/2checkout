...
// Connect to a TCP server identified by name
// (DNS name or dotted decimal string) and port
...
// Use getpeername to extract remote peer address.
// Fill buffer with address format IP_address:port
